...
网页右侧可设置:打印机、纸张(A4/A3/A5/A6/Letter/Legal)、**缩放**、份数、颜色、
页面范围、**自动旋转**、**自动居中**、双面。

**缩放**有下拉选项(实际大小 100% / 适应页面 / 过大才缩小 / 自定义%)与百分比输入框,
两者**联动同步**:选「实际大小」自动填 100,选「自定义%」可输入任意比例(10–400),
改百分比则自动切到「自定义%」;选「适应/缩小」时忽略百分比。
